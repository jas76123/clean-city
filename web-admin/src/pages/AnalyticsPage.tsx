    ...
    <div className="flex flex-col gap-4 p-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400">Стратегические показатели по жалобам и SLA</p>
        </div>
      ...
      <section className="grid grid-cols-4 gap-4">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          ...
          <div className="mt-1 text-xs text-slate-500">закрыто за период</div>
        </div>
      </section>
      ...
      <section>
        <h2 className="mb-2 text-sm font-medium text-slate-700">Equity по районам</h2>
        <EquityTable items={byDistrict.data ?? []} />
      </section>

      <section>
        <h2 className="mb-2 text-sm font-medium text-slate-700">Топ категорий</h2>
      ...
      <section>
        <h2 className="mb-2 text-sm font-medium text-slate-700">SLA по категориям</h2>
